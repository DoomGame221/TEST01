...
void CWeaponMINIGUN::Precache()
{
	...
	PrecacheModel("models/weapons/w_minigun_MINIGUN.mdl");
	PrecacheModel("models/weapons/v_minigun_MINIGUN.mdl");
	PrecacheModel("models/weapons/t_smg_MINIGUN.mdl");
}
...
// Output : Activity
//-----------------------------------------------------------------------------
Activity CWeaponMINIGUN::GetPrimaryAttackActivity()
{
	if (m_nShotsFired < 2)
...
// Purpose: 
//-----------------------------------------------------------------------------
void CWeaponMINIGUN::AddViewKick()
{
...
// Purpose: 
//-----------------------------------------------------------------------------
void CWeaponMINIGUN::SecondaryAttack()
{
}
